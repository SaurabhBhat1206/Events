package com.events.hanle.events.GCM.gcm;
...
public class NotificationUtils {
    ...
    public void showNotificationMessage(final String title, final String message, final String timeStamp, Intent intent, String imageUrl) {
        ...
        String input_value = sharedpreferences.getString(USER_INPUT, null);
        if (TextUtils.isEmpty(message))
            return;


        // notification icon
        final int icon = R.mipmap.nooi;
        ...
        if (input_value.equalsIgnoreCase("off")) {
            alarmSound = Uri.parse(ContentResolver.SCHEME_ANDROID_RESOURCE
                    + "://" + mContext.getPackageName() + "/raw/hanle");
        } else {
            alarmSound = null;
        }


        Log.d("value", input_value);
    ...
    public void playNotificationSound() {
        try {
            Uri alarmSound = Uri.parse(ContentResolver.SCHEME_ANDROID_RESOURCE
                    + "://" + MyApplication.getInstance().getApplicationContext().getPackageName() + "/raw/hanle");
