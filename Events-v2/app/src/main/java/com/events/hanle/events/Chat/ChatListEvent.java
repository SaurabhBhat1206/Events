...
import com.events.hanle.events.adapter.ChatRoomsAdapter;
...
public class ChatListEvent extends Fragment {

    private String TAG = ChatListEvent.class.getSimpleName();
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.activity_chat_list, container, false);
    ...
    private void launchLoginActivity() {
        Intent intent = new Intent(getActivity(), ChatLogin.class);
